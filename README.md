...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oceanspy-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `oceanspy` can be installed with:

```
conda install oceanspy
```

It is possible to list all of the versions of `oceanspy` available on your platform with:
